...
/** New dealer registration (pending TVS approval), links from Login. */
public class RegisterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.addView(Ui.tv(this, "Applications are verified by your TVS Area Manager before activation.",
