...
public class SsoLoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.addView(Ui.tv(this, "Sign in with TVS SSO", 17f, 0xFF141B2E, true));
        card.addView(Ui.tv(this, "Use the credentials issued to your dealership by TVS Motor Company.",
