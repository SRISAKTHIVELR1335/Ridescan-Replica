...
public class TutorialActivity extends BaseActivity {
    ...
    private static final String[] TITLES = new String[]{ "Diagnose any TVS two-wheeler", "Connect via TechPRO VCI", "Flash, report & go" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.Theme_RideScan_Dark);
    ...
    private void show(int i) {
        ...
        for (int k = 0; k < SLIDES.length; k++) {
            ...
            d.setBackground(Ui.roundRect(k == i ? 0xFF00347E : 0xFFCFD8E2, 6, this));
    ...
    private void finishTutorial() {
        getSharedPreferences("ridescan", MODE_PRIVATE).edit().putBoolean("tutorial_seen", true).apply();
