...
public class NotificationActivity extends BaseActivity {
    private static final String[][] NOTIFS = {
        {"VCI Firmware Updates Available!", "Version 2.19.1 is available for your TZ VCI and TechPRO devices.", "2h ago", "true"},
        {"App Update — RIDE Scan 2.3.7", "Adds Raider 125 ISG flash support and U796 cluster coverage.", "Yesterday", "true"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < NOTIFS.length; i++) {
            ...
            if ("true".equals(n[3])) {
                dot.setBackground(Ui.roundRect(0xFFE4002B, 20, this));
