...
public class UpdateActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.addView(Ui.tv(this, "RIDE Scan 2.3.7", 17f, 0xFF141B2E, true));
        card.addView(Ui.tv(this, "amsmssi.com/DMS/updates/ridescan-2.3.7.apk", 12f, 0xFF5A6472, false));
        state = Ui.tv(this, "Downloading File...", 13.5f, 0xFF00347E, true);
