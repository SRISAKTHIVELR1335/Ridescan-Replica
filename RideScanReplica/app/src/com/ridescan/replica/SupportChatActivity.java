...
/** Support chatbot ("Welcome to RIDE Scan Chatbot!") with canned technician Q&A. */
public class SupportChatActivity extends BaseActivity {
    ...
    private static final String[][] QNA = {
        ...
        {"firmware", "VCI firmware: Home → VCI Firmware Update → pick your dongle generation (TZ VCI / Mini / New / TechPRO). Recovery uses the bundled Renesas image."},
    ...
    private void suggest(final String label, final String key) {
        TextView chip = Ui.chip(this, label, R.drawable.bg_chip, 0xFF00347E);
    ...
    private void bubble(String text, boolean bot) {
        ...
        t.setBackground(Ui.roundRect(bot ? 0xFFE8F1F9 : 0xFF00347E, 12, this));
